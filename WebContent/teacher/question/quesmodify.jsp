...
<body>
	<div class="contact" >
		<form style="background-color: #D4D4D4" name="form1" action="questionModifyServlet" onsubmit="return verInput();" method="post">
			...
			<ul>
				...
				<li>
					<label>题目：</label>
					<textarea name="queTitle" id="queTitle" style="resize: none;">${questionMap.queTitle}</textarea>
				</li>
				<li>
					<label>选项A：</label>
					<input type="text" name="choiceA" id="choiceA" value='${questionMap.choiceA}' />
				</li>
				<li>
					<label>选项B：</label>
					<input type="text" name="choiceB" id="choiceB" value='${questionMap.choiceB}' />
				</li>
				<li>
					<label>选项C：</label>
					<input type="text" name="choiceC" id="choiceC" value='${questionMap.choiceC}' />
				</li>
				<li>
					<label>选项D：</label>
					<input type="text" name="choiceD" id="choiceD" value='${questionMap.choiceD}' />
				</li>
				<li>
					<label>正确答案：</label>
					<input type="text" name="ans" id="ans" value='${questionMap.ans}'/>
				</li>
			</ul>
